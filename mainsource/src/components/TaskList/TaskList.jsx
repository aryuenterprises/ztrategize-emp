    ...
    <div className="w-full">
      ...
      {taskLoading ? (
        <div className="flex justify-center items-center w-full h-screen">
          ...
          <div className="w-12 h-12 border-4 border-blue-500 rounded-full animate-ping">
        ...
        <div className=" p-5 w-full md:mt-10">
          ...
          <div className="flex flex-wrap md:flex-nowrap justify-around  gap-8 my-8 ">
          ...
          <div className="flex justify-between mt-8 mb-6">
            <div className="flex flex-col md:flex-row gap-4">
              <Dropdown
                ...
                className="w-[280px] md:w-[300px] md:px-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              ...
              {employeeRole === "Software Testing" && (
                <input
                  ...
                  className="px-2 md:w-[250px] border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400 "
                />
              )}
              {employeeRole !== "Software Testing" && (
                <input
          ...
          <DragDropContext onDragEnd={onDragEnd}>
            ...
            <div className="kanban-scroll h-[600px] w-full overflow-y-auto overflow-x-auto scroll-smooth custom-scrollbar pr-6">
